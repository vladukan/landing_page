...
<div class="container">
    <div class="row">
        ...
        <div ng-show="admin_panel">
			...
			<div class="col-md-2 col-xs-6" ng-click="admin_set()">
                <a class="btn btn-default col-md-12 col-xs-12" href="" style="margin-top: 10px;margin-bottom: 10px ">
                    <strong class="file_manager">Доступ </strong><i class="fa fa-unlock"></i></a>
            </div>
            ...
            <ul class="nav nav-tabs col-md-12 col-xs-12">
                <li role="presentation" class="{{-1==active_link ? 'active':''}}" ng-click="link_menu('-1','orders')">
                    <a href="">Заказы</a>
                </li>
                <li role="presentation" class="{{-2==active_link ? 'active':''}}" ng-click="link_menu('-2','statistic')">
                    <a href="">Статистика</a>
                </li>
                <li role="presentation" class="{{0==active_link ? 'active':''}}" ng-click="link_menu('0','main_menu')">
                    <a href="">Меню</a>
                </li>
                <li role="presentation" class="{{1==active_link ? 'active':''}}" ng-click="link_menu('1','headers')">
                    <a href="">Заголовки</a>
                </li>
                <li role="presentation" class="{{2==active_link ? 'active':''}}" ng-click="link_menu('2','text_headers')">
                    <a href="">Тексты</a>
                </li>

<!--                <li role="presentation" ng-repeat="item in menu track by $index"-->
<!--                    class="{{item[1]==active_link ? 'active':''}}" ng-click="link_menu(item[1],item[3])">-->
<!--                    <a href="">{{item[2]}}</a>-->
<!--                </li>-->
            </ul>
            <!--PAGES-->
            ...
            <div ng-show="page">
                ...
                <div class="col-md-12 col-xs-12" style="overflow-x: scroll;margin-bottom: 50px;" ng-show="table_show">
...
<!--        ADD MAIN MENU-->
        <div class="col-md-12 col-xs-12 well" ng-show="add_menu" style="margin-top: 30px;">
            <div class="col-md-12">
                <h5>{{title_add}}</h5>
                <i class="fa fa-close" ng-click="close_add()" style="float: right;font-size: 25px;margin-top: -50px;cursor: pointer"></i>
            </div>
            <div class="col-md-6 col-xs-12">
            <label>Номер меню</label>
                <input type="number" class="form-control" ng-model="number_page" aria-describedby="sizing-addon1">

            </div>
            <div class="col-md-6 col-xs-12">
                <label>Название</label>
                    <input type="text" class="form-control" ng-model="name_page" aria-describedby="sizing-addon1">

            </div>
            <div class="col-md-6 col-xs-12">
                <label>Ссылка</label>
                    <input type="text" class="form-control" ng-model="link_page" aria-describedby="sizing-addon1">
            </div>
            <div class="col-md-6 col-xs-12">
                <label>Заголовок</label>
                <input type="text" class="form-control" ng-model="text_page" aria-describedby="sizing-addon1">
            </div>
            <div class="col-md-12 col-xs-12">
                <label>Описание</label>
                <div ckeditor="options" ng-model="content_page" ></div>
            </div>
            <div class="col-md-6 col-xs-12">
                <label>Телефон</label>
                <input type="number" class="form-control" ng-model="phone_page" aria-describedby="sizing-addon1">
            </div>
            <div class="col-md-6 col-xs-12">
                <label>Фон страницы</label>
                <input type="text" readonly class="form-control" ng-model="fon_page" ng-click="file_mng()" aria-describedby="sizing-addon1">
            </div>

            <div class="col-md-6 col-xs-6" style="margin-top: 20px">
                <a class="btn btn-default col-md-12 col-xs-12" ng-click="save_main_menu()">
                    <strong>Сохранить </strong><i class="fa fa-save"></i>
                </a>
            </div>
            <div class="col-md-6 col-xs-6" style="margin-top: 20px">
                <a class="btn btn-default col-md-12 col-xs-12" ng-click="close_add()">
                    <strong>Отмена </strong><i class="fa fa-times"></i>
                </a>
            </div>
        </div>
<!--        ADD COMMENTS-->
        <div class="col-md-12 col-xs-12 well" ng-show="add_comment" style="margin-top: 30px;">
            <div class="col-md-12">
                <h5>{{title_add}}</h5>
                <i class="fa fa-close" ng-click="close_add()" style="float: right;font-size: 25px;margin-top: -50px;cursor: pointer"></i>
            </div>
            <div class="col-md-6 col-xs-12">
            <label>Имя</label>
                <input type="text" class="form-control" ng-model="name_comment" aria-describedby="sizing-addon1">

            </div>
            <div class="col-md-6 col-xs-12">
                <label>Телефон</label>
                    <input type="number" class="form-control" ng-model="phone_comment" aria-describedby="sizing-addon1">
            </div>
            <div class="col-md-6 col-xs-12">
                <label>Фото</label>
                <input type="text" readonly class="form-control" ng-model="foto_comment" ng-click="file_mng()" aria-describedby="sizing-addon1">
            </div>
            <div class="col-md-12 col-xs-12">
                <label>Отзыв</label>
                <div ckeditor="options" ng-model="content_comment" ></div>
            </div>
            <div class="col-md-12 col-xs-12">
                <label>Результат</label>
                <div ckeditor="options" ng-model="result_comment" ></div>
            </div>

            <div class="col-md-6 col-xs-6" style="margin-top: 20px">
                <a class="btn btn-default col-md-12 col-xs-12" ng-click="save_comment()">
                    <strong>Сохранить </strong><i class="fa fa-save"></i>
                </a>
            </div>
            <div class="col-md-6 col-xs-6" style="margin-top: 20px">
        ...
        <!--        ADD brends-->
        <div class="col-md-8 col-md-offset-2 col-xs-12 well" ng-show="add_brends" style="margin-top: 30px;">
            <div class="col-md-12">
                <h5>{{title_add}}</h5>
                <i class="fa fa-close" ng-click="close_add()" style="float: right;font-size: 25px;margin-top: -50px;cursor: pointer"></i>
            </div>
            <div class="col-md-8 col-md-offset-2 col-xs-12">
                <label for="nomer">Название</label>
                <input type="text" class="form-control" ng-model="name_brends" aria-describedby="sizing-addon1">

            </div>
            <div class="col-md-8 col-md-offset-2 col-xs-12">
                <label for="name">Картинка</label>
                <input type="text" readonly class="form-control" ng-model="img_brends" aria-describedby="sizing-addon1">
                <a class="btn btn-default col-md-12 col-xs-12" ng-click="file_mng()"><strong>Выбрать картинку...</strong></a>
            </div>


            <div class="col-md-6 col-xs-6" style="margin-top: 20px">
                <a class="btn btn-default col-md-12 col-xs-12" ng-click="save_brends()">
                    <strong>Сохранить </strong><i class="fa fa-save"></i>
                </a>
            </div>
            <div class="col-md-6 col-xs-6" style="margin-top: 20px">
...
<!--        ADD BENEFIT-->
        <div class="col-md-8 col-md-offset-2 col-xs-12 well" ng-show="add_benefit" style="margin-top: 30px;">
            <div class="col-md-12">
                <h5>{{title_add}}</h5>
                <i class="fa fa-close" ng-click="close_add()" style="float: right;font-size: 25px;margin-top: -50px;cursor: pointer"></i>
            </div>
            <div class="col-md-6 col-xs-12">
                ...
                <input type="number" class="form-control" ng-model="number_benefit" aria-describedby="sizing-addon1">
            </div>

            <div class="col-md-12 col-xs-12">
                <label>Текст выгоды</label>
                <div ckeditor="options" ng-model="text_benefit" ></div>
            </div>

            <div class="col-md-6 col-xs-6" style="margin-top: 20px">
                <a class="btn btn-default col-md-12 col-xs-12" ng-click="save_benefit()">
                    <strong>Сохранить </strong><i class="fa fa-save"></i>
                </a>
            </div>
            <div class="col-md-6 col-xs-6" style="margin-top: 20px">
...
<!--        ADD SERVICE-->
        <div class="col-md-8 col-md-offset-2 col-xs-12 well" ng-show="add_service" style="margin-top: 30px;">
            <div class="col-md-12">
                <h5>{{title_add}}</h5>
                <i class="fa fa-close" ng-click="close_add()" style="float: right;font-size: 25px;margin-top: -50px;cursor: pointer"></i>
            </div>
            <div class="col-md-6 col-xs-12">
                <label for="nomer">Номер</label>
                <input type="number" class="form-control" ng-model="number_service" aria-describedby="sizing-addon1">
            </div>
            <div class="col-md-6 col-xs-12">
                <label for="nomer">Название</label>
                <input type="text" class="form-control" ng-model="name_service" aria-describedby="sizing-addon1">
            </div>
            <div class="col-md-6 col-xs-12">
                <label>Картинка</label>
                <input type="text" readonly class="form-control" ng-model="img_service" ng-click="file_mng()" aria-describedby="sizing-addon1">
            </div>

            <div class="col-md-12 col-xs-12">
                <label>Описание</label>
                <div ckeditor="options" ng-model="text_service" ></div>
            </div>

            <div class="col-md-6 col-xs-6" style="margin-top: 20px">
                <a class="btn btn-default col-md-12 col-xs-12" ng-click="save_service()">
                    <strong>Сохранить </strong><i class="fa fa-save"></i>
                </a>
            </div>
            <div class="col-md-6 col-xs-6" style="margin-top: 20px">
...
<!--        ADD WHY WE-->
        <div class="col-md-8 col-md-offset-2 col-xs-12 well" ng-show="add_why" style="margin-top: 30px;">
            <div class="col-md-12">
                <h5>{{title_add}}</h5>
                <i class="fa fa-close" ng-click="close_add()" style="float: right;font-size: 25px;margin-top: -50px;cursor: pointer"></i>
            </div>
            <div class="col-md-6 col-xs-12">
                <label for="nomer">Номер</label>
                <input type="number" class="form-control" ng-model="number_why" aria-describedby="sizing-addon1">
            </div>
            <div class="col-md-6 col-xs-12">
                <label>Картинка</label>
                <input type="text" readonly class="form-control" ng-model="img_why" ng-click="file_mng()" aria-describedby="sizing-addon1">
            </div>
            <div class="col-md-6 col-xs-12">
                <label for="nomer">Заголовок</label>
                <input type="text" class="form-control" ng-model="name_why" aria-describedby="sizing-addon1">
            </div>

            <div class="col-md-12 col-xs-12">
                <label>Описание</label>
                <div ckeditor="options" ng-model="text_why" ></div>
            </div>

            <div class="col-md-6 col-xs-6" style="margin-top: 20px">
                <a class="btn btn-default col-md-12 col-xs-12" ng-click="save_why()">
                    <strong>Сохранить </strong><i class="fa fa-save"></i>
                </a>
            </div>
            <div class="col-md-6 col-xs-6" style="margin-top: 20px">
...
<!--        EDIT ORDERS-->
        <div class="col-md-8 col-md-offset-2 col-xs-12 well" ng-show="add_order" style="margin-top: 30px;">
            <div class="col-md-12">
                <h5>{{title_add}}</h5>
                <i class="fa fa-close" ng-click="close_add()" style="float: right;font-size: 25px;margin-top: -50px;cursor: pointer"></i>
            </div>
            <div class="col-md-6 col-md-offset-3 col-xs-12">
                <label>Имя</label>
                <input type="text" class="form-control" ng-model="name_order" aria-describedby="sizing-addon1">
            </div>

            <div class="col-md-6 col-md-offset-3 col-xs-12">
                <label>Телефон</label>
                <input type="number" class="form-control" ng-model="phone_order" aria-describedby="sizing-addon1">
            </div>

            <div class="form-group col-md-6 col-md-offset-3 col-xs-12">
                <label for="sum">Количество записей:</label>
                <select class="form-control" id="sum" ng-model="status_order">
                    <option>Не выполнено</option>
                    <option>Выполнено</option>
                </select>
            </div>
            <div class="col-md-6 col-xs-6" style="margin-top: 20px">
                <a class="btn btn-default col-md-12 col-xs-12" ng-click="save_order()">
                    <strong>Сохранить </strong><i class="fa fa-save"></i>
                </a>
            </div>
            <div class="col-md-6 col-xs-6" style="margin-top: 20px">
...
<!--        ////////////////////////////////-->
        ...
        <div class="col-md-4 col-md-offset-4 col-xs-12 alert alert-danger" role="alert" ng-show="error"
             style="text-align: center;padding: 5px;position: absolute;bottom: 50px;">
